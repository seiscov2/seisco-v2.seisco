...
import seisco.util.yaml.Configuration;
import seisco.util.yaml.ConfigurationSection;
import seisco.util.yaml.InvalidConfigurationException;
import seisco.util.yaml.serialization.ConfigurationSerializable;
import seisco.util.yaml.serialization.ConfigurationSerialization;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            if (ex.getCause() instanceof YAMLException) {
                System.out.println("Config file " + file + " isn't valid! " + ex.getCause());
            } else if ((ex.getCause() == null) || (ex.getCause() instanceof ClassCastException)) {
                System.out.println("Config file " + file + " isn't valid!");
            } else {
                System.out.println("Cannot load " + file + ": " + ex.getCause().getClass());
            }
        }
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
            ...
            if (ex.getCause() instanceof YAMLException) {
                System.out.println("Config file isn't valid! " + ex.getCause());
            } else if ((ex.getCause() == null) || (ex.getCause() instanceof ClassCastException)) {
                System.out.println("Config file isn't valid!");
            } else {
                System.out.println("Cannot load configuration: " + ex.getCause().getClass());
            }
        }
